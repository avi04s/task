...
elseif (
    ...
    $returnData = msg(0, 422, 'Please Fill in all Required Fields!','null','null','null', $fields);
...
// IF THERE ARE NO EMPTY FIELDS THEN-
    ...
    elseif (strlen($name) < 3) :
        $returnData = msg(0, 422, 'Your name must be at least 3 characters long!','null','null','null');
        ...
        try {
            ...
            if(isset($_FILES['file']['tmp_name'])):
                ...
                if(in_array($fileExt, $valid_extensions)):
                    ...
                    $returnData = msg(0, 422, 'Sorry, only JPG, JPEG, PNG & GIF files are allowed','null','null','null');
            ...
            if ($check_email_stmt->rowCount()) :
                ...
                if(isset($_FILES['file']['tmp_name'])):
                    $insert_query = "UPDATE `users` SET `name`=:name, `email`=:email, `file`=:file  WHERE `id`=:id ";
                else:
                ...
                $returnData = msg(1, 201, 'You have successfully updated.',$email,$name,$file);

           else :
               
               $returnData = msg(0, 422, 'This E-mail is not registered!','null','null','null');
